...
public class FightKugeln extends GraphicsProgram {
	...
	public void getKreisFigt(long it) {
		for (int i = 0; i < it; i++) {
			...
			if (a.leben > 0 && b.leben > 0) {

				double distQ1 = (a.posX - b.posX) * (a.posX * -b.posX);
				double distQ2 = (a.posY - b.posY) * (a.posY * -b.posY);
				double distQ3 = (a.posZ - b.posZ) * (a.posZ * -b.posZ);

				double distanz = distQ1 + distQ2 + distQ3;

				if (a.damagedistanz > distanz)
					b.leben -= a.schaden;
				if(b.leben<=0) {b.posX+=(Math.random()*b.leben);b.posX-=(Math.random()*b.leben);
				b.posY+=(Math.random()*b.leben);b.posY-=(Math.random()*b.leben);
				b.posZ+=(Math.random()*b.leben);b.posZ-=(Math.random()*b.leben);
				b.leben=b.lebenIMax*Math.random();}
			}
	...
	public void konstStrukt2(double maxx, double maxy, double maxz, double maxleben, double maxdistanz,
			double maxschaden, double maxspeed) {
